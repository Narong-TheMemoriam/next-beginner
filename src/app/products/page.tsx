...
{products.map((product, index) => (
  <div key={product.id} className='flex flex-col p-4 border border-red-500 rounded-lg'>
    <img src={product.photo}
    alt="Laptop" className="h-40 rounded-lg object-contain"
    />
    
    <div className='flex justify-between'>
      <div>
        <h3 className='font-semibold text-xl text-blue-500'>Laptop</h3>
